  ...
  <div class="p-5">
    <div class="flex flex-col items-center">
      ...
      <div class="text-theme-wallet-primary-text">
        <span class="text-5xl font-bold">{{ wallet.balance }}&nbsp;</span>
        <span class="text-2xl">{{ coinInfo.ticker }}</span>
      </div>
      <div>
      ...
      <div class="mt-5 flex w-full max-w-full">
        <v-expansion-panels flat multiple>
          <v-expansion-panel>
            ...
            >
              Binance Coint (BNB) is the native token of Binance Chain and the key base asset on the Binance decentralalized exchange (DEX). It is used to pay the transaction fees of assets that live on Binance Chain.
            </v-expansion-panel-content>
          </v-expansion-panel>
        </v-expansion-panels>
      </div>
